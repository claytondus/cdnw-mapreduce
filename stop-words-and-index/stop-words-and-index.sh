...
hadoop jar $HADOOP_DIR/share/hadoop/tools/lib/hadoop-streaming-2.7.2.jar -files mapper4.py,reducer4.py,stop-words.txt -mapper mapper4.py -reducer reducer4.py -input pa2/shake/ -output pa2/inverted_index
